...
proto.ledger_swap.NewTransactionResponse.prototype.getAmountToProvider_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getAmountToProvider()));
};
...
proto.ledger_swap.NewTransactionResponse.prototype.getAmountToProvider_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getAmountToProvider()));
};
...
proto.ledger_swap.NewTransactionResponse.prototype.getAmountToWallet_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getAmountToWallet()));
};
...
proto.ledger_swap.NewTransactionResponse.prototype.getAmountToWallet_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getAmountToWallet()));
};
...
proto.ledger_swap.UDecimal.prototype.getCoefficient_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getCoefficient()));
};
  ...
  proto.ledger_swap.NewSellResponse.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        outAmount:
          (f = msg.getOutAmount()) && proto.ledger_swap.UDecimal.toObject(includeInstance, f),
...
proto.ledger_swap.NewSellResponse.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(6, f, proto.ledger_swap.UDecimal.serializeBinaryToWriter);
  }
...
proto.ledger_swap.NewSellResponse.prototype.getInAmount_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getInAmount()));
};
...
proto.ledger_swap.NewSellResponse.prototype.getDeviceTransactionId_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getDeviceTransactionId()));
};
...
proto.ledger_swap.NewSellResponse.prototype.getDeviceTransactionId_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getDeviceTransactionId()));
};
